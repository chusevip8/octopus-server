...
// @Param data body octopus.Message true "创建消息"
...
// @accept application/json
// @Produce application/json
// @Param data body octopus.Message true "删除消息"
...
// @accept application/json
// @Produce application/json
// @Param data body octopus.Message true "更新消息"
...
// @accept application/json
// @Produce application/json
// @Param data query octopus.Message true "用id查询消息"
...
// @accept application/json
// @Produce application/json
// @Param data query octopusReq.MessageSearch true "分页获取消息列表"
