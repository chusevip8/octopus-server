...
// @Param data body model.Message true "创建私信"
...
// @accept application/json
// @Produce application/json
// @Param data body model.Message true "删除私信"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除私信"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /message/deleteMessage [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.Message true "更新私信"
...
// @accept application/json
// @Produce application/json
// @Param data query model.Message true "用id查询私信"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取私信列表"
