<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="任务参数Id" prop="taskOptionId" width="120" />
        <el-table-column align="left" label="设备Id" prop="deviceId" width="120" />
        <el-table-column align="left" label="任务状态" prop="status" width="120" />
        <el-table-column align="left" label="任务错误信息" prop="error" width="120" />
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="任务类型:"  prop="type" >
              <el-input v-model.number="formData.type" :clearable="false" placeholder="请输入任务类型" />
            </el-form-item>
            <el-form-item label="任务参数Id:"  prop="taskOptionId" >
              <el-input v-model.number="formData.taskOptionId" :clearable="false" placeholder="请输入任务参数Id" />
            </el-form-item>
            <el-form-item label="设备Id:"  prop="deviceId" >
              <el-input v-model.number="formData.deviceId" :clearable="false" placeholder="请输入设备Id" />
            </el-form-item>
            <el-form-item label="任务状态:"  prop="status" >
              <el-input v-model.number="formData.status" :clearable="false" placeholder="请输入任务状态" />
            </el-form-item>
