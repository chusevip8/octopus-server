        ...
        <el-table-column align="center" label="操作" fixed="right" min-width="120">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updateScriptFunc(scope.row)">修改</el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
      ...
      <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="内容:" prop="content">
          <el-input v-model="formData.content" :rows="30" type="textarea" />
        </el-form-item>
        <el-form-item label="备注:" prop="note">
...
const onDelete = async () => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    const res = await deleteScriptByIds({ IDs })
    if (res.code === 0) {
      ElMessage({
        type: 'success',
        message: '删除成功'
