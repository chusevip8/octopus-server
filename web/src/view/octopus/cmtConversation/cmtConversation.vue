<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="会话Id" prop="threadId" width="120" />
        <el-table-column align="left" label="发评论者" prop="commenter" width="120" />
        <el-table-column align="left" label="发评论者Id" prop="commentId" width="120" />
        <el-table-column align="left" label="评论回复者" prop="commentReplier" width="120" />
        <el-table-column align="left" label="评论回复者Id" prop="commentReplierId" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateCmtConversationFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getCmtConversationList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
