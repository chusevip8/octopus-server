    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="评论记录Id:"  prop="conversationId" >
              <el-input v-model.number="formData.conversationId" :clearable="false" placeholder="请输入评论记录Id" />
            </el-form-item>
            <el-form-item label="评论内容:"  prop="content" >
              <el-input v-model="formData.content" :clearable="false"  placeholder="请输入评论内容" />
            </el-form-item>
            <el-form-item label="评论状态:"  prop="status" >
              <el-input v-model.number="formData.status" :clearable="false" placeholder="请输入评论状态" />
            </el-form-item>
          </el-form>
    </el-drawer>
  </div>
